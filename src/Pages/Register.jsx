...
const Register = () => {
  const [state, handleSubmit] = useForm("xyzdrlzp");
  if (state.succeeded) {
  ...
  return (
    ...
    <section className='py-16 px-4 bg-white'>
      ...
      <input type="text" id='fullName' name='fullName' required placeholder='e.g Dee Prince' className='text-center border-b-2 outline-0 mb-6'/>
      <ValidationError 
        prefix="Text" 
        field="text"
        errors={state.errors}
